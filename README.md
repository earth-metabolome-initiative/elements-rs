...
The feature is [`no_std`](https://docs.rust-embedded.org/book/intro/no-std.html), and optionally supports [`serde`](https://serde.rs/) for serialization/deserialization.
