...
impl From<ChromiumIsotope> for crate::Isotope {
    fn from(isotope: ChromiumIsotope) -> Self {
        crate::Isotope::Cr(isotope)
    }
}
impl From<ChromiumIsotope> for crate::Element {
    fn from(_isotope: ChromiumIsotope) -> Self {
        crate::Element::Cr
    }
}
impl TryFrom<u64> for ChromiumIsotope {
...
impl TryFrom<u8> for ChromiumIsotope {
    type Error = crate::errors::Error;
...
impl TryFrom<u32> for ChromiumIsotope {
    type Error = crate::errors::Error;
    fn try_from(value: u32) -> Result<Self, Self::Error> {
        Self::try_from(u64::from(value))
    }
}
impl core::fmt::Display for ChromiumIsotope {
...
mod tests {
    ...
    fn test_relative_atomic_mass() {
        for isotope in ChromiumIsotope::iter() {
    ...
    fn test_element() {
        for isotope in ChromiumIsotope::iter() {
            ...
            assert_eq!(element, crate::Element::Cr, "Element should be correct for {isotope:?}");
        }
    }
    #[test]
    fn test_mass_number() {
    ...
    fn test_most_abundant() {
        let most_abundant = ChromiumIsotope::most_abundant_isotope();
    ...
    fn test_from_isotope() {
        for isotope in ChromiumIsotope::iter() {
            ...
            match iso {
                crate::Isotope::Cr(i) => assert_eq!(i, isotope),
    ...
    fn test_from_element() {
        for isotope in ChromiumIsotope::iter() {
            ...
            assert_eq!(elem, crate::Element::Cr);
        }
    }
    #[test]
    fn test_try_from_mass_number() {
        for isotope in ChromiumIsotope::iter() {
            ...
            let iso = ChromiumIsotope::try_from(mass).unwrap();
            assert_eq!(iso, isotope);
            let iso_u32 = ChromiumIsotope::try_from(u32::from(mass)).unwrap();
            assert_eq!(iso_u32, isotope);
            if let Ok(mass_u8) = u8::try_from(mass) {
                let iso_u8 = ChromiumIsotope::try_from(mass_u8).unwrap();
                assert_eq!(iso_u8, isotope);
            }
        }
        assert!(ChromiumIsotope::try_from(0_u16).is_err());
        assert!(ChromiumIsotope::try_from(1000_u16).is_err());
        assert!(ChromiumIsotope::try_from(0_u32).is_err());
        assert!(ChromiumIsotope::try_from(1000_u32).is_err());
        assert!(ChromiumIsotope::try_from(0_u8).is_err());
    }
    #[test]
    fn test_display() {
        for isotope in ChromiumIsotope::iter() {
