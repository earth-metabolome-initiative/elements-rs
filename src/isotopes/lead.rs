...
impl From<LeadIsotope> for crate::Isotope {
    fn from(isotope: LeadIsotope) -> Self {
        crate::Isotope::Pb(isotope)
    }
}
impl From<LeadIsotope> for crate::Element {
...
impl core::fmt::Display for LeadIsotope {
...
mod tests {
    ...
    fn test_relative_atomic_mass() {
        for isotope in LeadIsotope::iter() {
    ...
    fn test_element() {
        for isotope in LeadIsotope::iter() {
            ...
            assert_eq!(element, crate::Element::Pb, "Element should be correct for {isotope:?}");
        }
    }
    #[test]
    fn test_mass_number() {
    ...
    fn test_most_abundant() {
        let most_abundant = LeadIsotope::most_abundant_isotope();
    ...
    fn test_from_isotope() {
        for isotope in LeadIsotope::iter() {
            ...
            match iso {
                crate::Isotope::Pb(i) => assert_eq!(i, isotope),
    ...
    fn test_from_element() {
        for isotope in LeadIsotope::iter() {
            ...
            assert_eq!(elem, crate::Element::Pb);
        }
    }
    #[test]
    fn test_try_from_mass_number() {
        for isotope in LeadIsotope::iter() {
            ...
            let iso_u32 = LeadIsotope::try_from(u32::from(mass)).unwrap();
            assert_eq!(iso_u32, isotope);
            if let Ok(mass_u8) = u8::try_from(mass) {
                let iso_u8 = LeadIsotope::try_from(mass_u8).unwrap();
                assert_eq!(iso_u8, isotope);
            }
        }
        assert!(LeadIsotope::try_from(0_u16).is_err());
        assert!(LeadIsotope::try_from(1000_u16).is_err());
        assert!(LeadIsotope::try_from(0_u32).is_err());
        assert!(LeadIsotope::try_from(1000_u32).is_err());
        assert!(LeadIsotope::try_from(0_u8).is_err());
    }
    #[test]
    fn test_display() {
        for isotope in LeadIsotope::iter() {
